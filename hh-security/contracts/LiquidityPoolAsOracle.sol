...
//Using ChainLink's for decentralized Oralces is more secure than using some random centralized Oracle
...
contract LiquidityPoolAsOracle {
    ...
    //In this example, the return value is from a single entity; not a decentralized Oracle network whom agree on the return value before returning it to this smart contract
