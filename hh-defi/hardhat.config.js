...
const mainnetAddressAndKeyForForking = "https://mainnet.infura.io/v3/" + infuraAPIKey;
...
module.exports = {
  ...
  networks: {
    hardhat: {
      chainId: 31337,
      forking: {
        url: `${mainnetAddressAndKeyForForking}`
      }
    },
    goerli: {
      url: goerliRpcUrl,
  ...
  solidity: {
    compilers: [{version: "0.8.17"}, {version: "0.8.0"}, {version: "0.4.19" }, {version: "0.6.12"}]
  },
  gasReporter: {
    enabled: true,
