...
export interface GovenorContractInterface extends utils.Interface {
  functions: {
...
export interface GovenorContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovenorContractInterface;
